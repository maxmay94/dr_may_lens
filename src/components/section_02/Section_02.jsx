        ...
        <div className='pt-36'>
          <div className='text-center text-3xl bg-slate-600/20 rounded mx-auto w-3/4 backdrop-blur-md p-3'>
            ...
            <div className='text-base text-left'>
              <div className='p-2'>
                <p className='text-xl text-left underline'>Anxiety</p>
              ...
              <div className='p-2'>
                <p className='text-xl text-left underline'>Depression</p>
              ...
              <div className='p-2'>
                <p className='text-xl text-left underline'>Traumatic Brain Injury (TBI)</p>
              ...
              <div className='p-2'>
                <p className='text-xl text-left underline'>ADD/ADHD</p>
              ...
              <div className='p-2'>
                <p className='text-xl text-left underline'>Substance Abuse</p>
              ...
              <div className='p-2'>
                <p className='text-xl text-left underline'>Autism, Aspergers, OCD, Hair Pulling, Eating Disorders</p>
